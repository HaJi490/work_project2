...
export default function page() {
    ...
    return (
        <div className='w-7/10 max-w-[1300px]'>
            ...
            <div className="grid grid-cols-[1fr_3fr] justify-center items-center gap-4 mb-15">
                    ...
                    <input type="text" readOnly disabled value={memberDt?.createAt} className={`${style.noneInput} max-w-[450px]`} />
                    <div className="col-span-2 border-[0.5px] border-[#f2f2f2]" />
                    {/* 아이디 */}
                    ...
                    <label>휴대폰 번호</label>
                    <div>
                        <input type="text" placeholder='' value={memberDt?.phoneNumber} onChange={(e) => setPhone(e.target.value.trim())} className={`${style.inputbox} max-w-[450px] text-center`}/> 
                        {/* &ensp;-&ensp;
                    ...
                    <div className="flex gap-2 items-center">
                        <input type="text" value={memberDt?.email} onChange={(e) => setEmail(e.target.value.trim())} className={`${style.inputbox} max-w-[200px]`}/> &ensp;@&ensp;
